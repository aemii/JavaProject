<%-- 
    Document   : a_edit
    Created on : 28 Dec 2015, 11:26:21 PM
    Author     : Nimra Qasim
--%>
...
<div class="style2">
  <div class="ic style7">More Website Templates @ TemplateMonster.com - August 05, 2013!</div>
			...
			<p class="grid_2 style29">&nbsp;</p>
				...
				<input type="hidden" value="booking" name="RT">
			  ...
			  <%sess.setAttribute("place",request.getParameter("place"));%>
                <tr>
                  ...
                  <td width="911" class="style29"><p>&nbsp;</p>
                    <p align="center" class="style38 style45">Book Your Trip! Experience The Fun</p>
                    <p>&nbsp;</p>
                     <table width="644" height="465" align="center">
                    <tr>
                      <td width="290" height="93"><p align="center" class="style43">&nbsp;</p>
                        <p align="center" class="style43">Date: </p></td>
                      <td width="342" class="style39"><div align="center" class="style31 style7 style40">
                        <p>&nbsp;</p>
                        <p class="style38">
                          <label for="textfield"></label>
                          <input name="date" type="text" id="date" size="35" required="">
                        </p>
                      </div></td>
                    </tr>
                    <tr>
                      <td height="94"><div align="center" class="style43">
                        <p>&nbsp;</p>
                        <p class="style41">Name  :</p>
                      </div></td>
                      <td class="style39"><div align="center" class="style31 style7 style40">
                        <p>&nbsp;                        </p>
                        <p class="style38">
                          <input name="name" type="text" id="name" size="35" required="">
                        </p>
                      </div></td>
                    </tr>
                    <tr>
                      ...
                      <p align="center"><span class="style38">
                              <input name="number" type="text" id="number" size="35" required="">
                      </span></p></td>
                    </tr>
                    <tr>
                      <td height="89"><p class="style44">&nbsp;</p>
                      <p align="center" class="style43">Payment:</p></td>
                      <td class="style39"><p>&nbsp;</p>
                      <p align="center" class="style44">
                        <label for="radiobutton">Cash</label>
                        <input name="pay" type="radio" value="cash" id="radiobutton" required="">
                        <label for="label">Credit Card</label>
                        <input name="pay" type="radio" value="card" id="label" required="">
                      </p></td>
                    </tr>
                    <tr>
                      <td height="89"><p>&nbsp;</p>
                      <p align="center" class="style43">Days:</p></td>
                      <td class="style39">
                        <p align="center" class="style38">&nbsp;</p>                        <p align="center" class="style38">
                            <input name="days" type="text" id="number2" size="35" required="">
                          <span class="style48">Days</span></p></td>
                    </tr>
                  </table>
                  <p align="center">&nbsp;</p>
                  ...
                  <p href="index.html" align="center">
                    ...
                    <input name="book" type="submit" class="style43" id="book" value="BOOK NOW">
                  </p>
...
<footer>		
	...
	<div class="grid_12">
		<div class="socials">
			...
			<div class="copy">
		 Website designed by Toursit Guide
		 </div>
	</div>
		 <div class="clear"></div>
	</div>
