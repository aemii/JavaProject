...
<div class="style2">
  <div class="ic style7">More Website Templates @ TemplateMonster.com - August 05, 2013!</div>
			...
			<form action="controller" method="post">
				<input type="hidden" value="c_update" name="RT">
			  ...
			  <table width="1253" height="504">
                <tr>
                  ...
                  <td width="848" class="style29"><table width="541" height="374" align="center">
                    <tr>
                      ...
                      <td width="255" class="style35"><div align="center" class="style47">
                        ...
                        <p class="style50"><label for="textfield"></label>
                    ...
                    <tr>
                      ...
                      <td class="style35"><div align="center" class="style48">
                        ...
                        <p>
                          ...
                          <input name="email" type="text" id="label" size="35" value="<%=sess.getAttribute("id") %>">
                        </p>
                      </div></td>
                    </tr>
                    <tr>
                      ...
                      <p align="center">
                        ...
                        <input name="number" type="text" id="label2" size="35" value="<%=sess.getAttribute("number") %>">
                      </p></td>
                    </tr>
                    <tr>
                      ...
                      <p align="center">
                        ...
                        <input name="gender" type="text" id="label3" size="35" value="<%=sess.getAttribute("gender") %>">
                      </p></td>
                    </tr>
                  </table>
                    ...
                    <p align="center">&nbsp;</p>
                  <p align="center">
                    <input name="Submit" type="submit" class="style47" id="Submit" value="Submit">
                  </p>
