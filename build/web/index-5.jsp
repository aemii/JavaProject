...
<div class="menu_block">
           <nav  class="" >
             <ul class="sf-menu">
                   ...
                   <li><a href="controller?RT=gallery">Gallery</a></li>
				  
                   <li><a href="controller?RT=tours">Tours</a></li>
				   
                   <li class="current"><a href="controller?RT=contacts">Contacts</a></li>
...
<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - August 05, 2013!</div>
  ...
  <address>
    <dl>
      <dt>
        Abc, Lahore Pakistan. </dt>
                                  <dd><span>Freephone:</span>+1 123 456 789 </dd>
                                  <dd><span>Telephone:</span>+1 800 700 123 </dd>
                                  <dd><span>FAX:</span>+1 800 889 9898</dd>
                                  <dd>E-mail: <a href="#" class="link-1">mail@traveler.org</a></dd>
          </dl>
              </address>
                           <address class="mb0">
                             <dl>
